<div class="page-header">
    <h2><?= $this->url->link(t('My backlogs'), 'DashboardController', 'projects', array('user_id' => $user['id'])) ?> (<?= $paginator->getTotal() ?>)</h2>
</div>
<?php if ($paginator->isEmpty()): ?>
    <p class="alert"><?= t('You are not a member of any backlog.') ?></p>
<?php else: ?>
