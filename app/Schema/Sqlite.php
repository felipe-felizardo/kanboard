...
{
    $pdo->exec('ALTER TABLE projects ADD COLUMN is_backlog INTEGER DEFAULT 0 NOT NULL');
}
...
function version_125(PDO $pdo)
{
    ...
    $pdo->exec('ALTER TABLE projects ADD COLUMN scope_is_open INTEGER DEFAULT 1 NOT NULL');
}
